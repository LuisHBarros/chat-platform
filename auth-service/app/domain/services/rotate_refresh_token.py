...
class RotateRefreshToken:
    def __init__(self, cache_repository: CacheRepository, refresh_token_repository: RefreshTokenRepository, token_service: TokenService, user_repository: UserRepository):
